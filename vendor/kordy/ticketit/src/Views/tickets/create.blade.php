...
@include('ticketit::shared.header')
    <div class="well bs-component">
        {!! CollectiveForm::open([
            ...
            <div class="form-group">
                {!! CollectiveForm::label('trigger', trans('¿En qué circunstancias se agrava o se reduce?') . trans('ticketit::lang.colon'), ['class' => 'col-lg-2 control-label']) !!}                               
                <div class="col-lg-10">
            ...
            <div class="form-group">
                {!! CollectiveForm::label('intensity', trans('¿Qué intensidad tiene?') . trans('ticketit::lang.colon'), ['class' => 'col-lg-2 control-label']) !!}                               
                <div class="col-lg-10">
