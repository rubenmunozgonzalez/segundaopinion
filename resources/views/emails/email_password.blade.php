                ...
                <td align="center" valign="top">
                    ...
                    <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" bgcolor="{{ $setting->grab('email.color_header_bg') }}">
                                    <tr>
                                        <td class="subject">
                                        <br>
                                            Bienvenido a la segunda opinión de Clínica CEMTRO
                                      </td>
                                  </tr>
                                  <tr>
                                    <td>
                                      ...
                                      <center>
                                        <table cellpadding="0" cellspacing="0" width="80%">
                                          <tr>
                                            <td style="margin: 20px; text-align: left; color:#fff;" align="center">
                                                <br>
                                                Clique aquí para cambiar su contraseña
                                                <br>
                                                <br>
                                            </td>
                                        </tr>
                            ...
                            <td>
                              <div><!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="{{ $setting->grab('email.color_button_bg') }}">
                                  ...
                                  <center>
                                    <![endif]-->
                                    <a href="<?php echo URL::to('/adminChangePassword?username='.$username)?>"
                                       style="background-color:{{ $setting->grab('email.color_content_bg') }};color:#005AA4;display:inline-block;font-family: Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:300px;-webkit-text-size-adjust:none;">Cambiar contraseña</a>
                                <!--[if mso]>
                                  </center>
                                </v:roundrect>
                                <![endif]--></div>
                    ...
                    <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="{{ $setting->grab('email.color_footer_bg') }}" style="margin: 0 auto">
                          <tr>
                            <td style="background-color:{{ $setting->grab('email.color_content_bg') }};">
                                <br>
                                <br>
                                  @if( (bool) $setting->grab('email.facebook_link') )
                                    <a href="{{ $setting->grab('email.facebook_link') }}"><img src="https://www.segundaopinioncemtro.com/public/assets/frontend/img/facebook.png" alt="facebook"></a>
                                  @endif
                                  @if( (bool) $setting->grab('email.twitter_link') )
                                    <a href="{{ $setting->grab('email.twitter_link') }}"><img src="https://www.segundaopinioncemtro.com/public/assets/frontend/img/twitter.png" alt="twitter"></a>
                                  @endif
                                  @if( (bool) $setting->grab('email.youtube_link') )
                                    <a href="{{ $setting->grab('email.youtube_link') }}"><img src="https://www.segundaopinioncemtro.com/public/assets/frontend/img/youtube.png" alt="facebook"></a>
                                  @endif
                                  @if( (bool) $setting->grab('email.linkedin_link') )
                                    <a href="{{ $setting->grab('email.linkedin_link') }}"><img src="https://www.segundaopinioncemtro.com/public/assets/frontend/img/linkedin.png" alt="linkedin"></a>
                                  @endif
                                <br>
                                <br>
                            </td>
