            ...
            @if($u->isAdmin())
                ...
                <li role="presentation" class="dropdown {!!
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li role="presentation"  class="{!! $tools->fullUrlIs(action('\Kordy\Ticketit\Controllers\UsersController@index').'*') ? "active" : "" !!}">
                            <a href="{{ action('\Kordy\Ticketit\Controllers\UsersController@index') }}">{{ trans('ticketit::admin.nav-users') }}</a>
                        </li>
                        ...
                        <li role="presentation"  class="{!! $tools->fullUrlIs(action('\Kordy\Ticketit\Controllers\PaymentsController@index').'*') ? "active" : "" !!}">
                            <a href="{{ action('\Kordy\Ticketit\Controllers\PaymentsController@index')}}">{{ trans('ticketit::admin.nav-payments') }}</a>
                        </li>
                    </ul>
                </li>
            @endif
