        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-sm-12">
                    ...
                    <div class="form-group col-lg-12">
                        {!! CollectiveForm::label('category_id',  trans('ticketit::lang.unit') . trans('ticketit::lang.colon'), [
                            'class' => 'col-lg-4 control-label'
                        ]) !!}
                        <div class="col-lg-8">
                            {!! CollectiveForm::select('category_id', $category_lists, $ticket->unit_id, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
