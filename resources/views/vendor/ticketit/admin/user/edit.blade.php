...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 wow fadeInLeft animated">
            ...
            <div class="form-group">
                <label for="patient_gender" class="col-xs-4">Edad:</label>
                <div class="col-xs-8">
                    <div class="col-sm-6">
            ...
            <div class="form-group">
                <div class="col-xs-4">
                  <?php echo Form::button('Atrás', array('class' => 'btn btn-default btn-block btn-flat inside_body_submit', 'onclick' => 'document.href = document.referrer;')) ?>
                </div>
                <div class="col-xs-8">
