...
ENDHTML
    ...
    , 'comment_notification' => <<<'ENDHTML'
			<p>
				<b>Notificación de respuestas</b>: Send notification when new comment is posted
			</p>
...
ENDHTML
    ...
    , 'agent_restrict' => <<<'ENDHTML'
            <p><b>Restricción de agente</b>: Restringir acceso de los especialistas a solo los tiquetes que tienen asignados</p>			
			<p>
