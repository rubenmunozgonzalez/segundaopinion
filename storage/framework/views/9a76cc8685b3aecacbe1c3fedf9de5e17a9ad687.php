    ...
    <div class="modal-dialog model-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-sm-12">
                    <?php /*<?php if($u->isAdmin()): ?>*/ ?>
                    <div class="form-group">
                        <?php echo CollectiveForm::text('subject', $ticket->subject, ['class' => 'form-control', 'required']); ?>

                    </div>
                    <div class="form-group">
                        <?php echo CollectiveForm::textarea('content', $ticket->html, [
                    ...
                    <div class="form-group col-lg-6">
                        <?php echo CollectiveForm::label('priority_id', trans('ticketit::lang.priority') . trans('ticketit::lang.colon'), ['class' => 'col-lg-4 control-label']); ?>

                        <div class="col-lg-8">
                            <?php echo CollectiveForm::select('priority_id', $priority_lists, $ticket->priority_id, ['class' => 'form-control']); ?>
                    ...
                    <div class="form-group col-lg-12">
                        <?php echo CollectiveForm::label('category_id',  trans('ticketit::lang.category') . trans('ticketit::lang.colon'), [
                            'class' => 'col-lg-6 control-label'
                        ]); ?>

                        <div class="col-lg-6">
                            <?php echo CollectiveForm::select('category_id', $category_lists, $ticket->category_id, ['class' => 'form-control']); ?>
