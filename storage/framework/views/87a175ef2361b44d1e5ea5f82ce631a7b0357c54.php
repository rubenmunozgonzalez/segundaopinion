...
<?php echo $__env->make('ticketit::shared.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class="well bs-component">
        <?php echo CollectiveForm::open([
            ...
            <div class="form-group">
                <?php echo CollectiveForm::label('intensity', trans('¿Qué intensidad tienen estos síntomas?') . trans('ticketit::lang.colon'), ['class' => 'col-lg-2 control-label']); ?>
            ...
            <div class="form-group">
                <?php echo CollectiveForm::label('trigger', trans('¿En qué circunstancias se agravan o se reducen los síntomas?') . trans('ticketit::lang.colon'), ['class' => 'col-lg-2 control-label']); ?>
