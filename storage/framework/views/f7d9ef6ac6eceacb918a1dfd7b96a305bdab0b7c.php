            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <td><?php echo e(trans('ticketit::admin.table-show-agent')); ?></td>
                ...
                <?php foreach($agents as $agent): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            'method' => 'GET',
                            'route' => [
                                        $setting->grab('admin_route').'.agent.edit',
                                        $agent->id
                                        ],
                            'id' => "edit-$agent->id"
                            ]); ?>

                            <?php echo CollectiveForm::submit(trans('ticketit::admin.btn-edit'), ['class' => 'btn btn-info']); ?>
