<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-10 wow fadeInLeft animated">
            ...
            <div class="form-group">
                <div class="col-xs-10">
                    <?php echo Form::checkbox('conditions', null, null, array('id' => "conditions"));?> Acepto las condiciones legales<br>
                    <?php echo Form::submit('Acceptar', array('class' => 'btn btn-primary btn-flat inside_body_submit')) ?>
                    <span class="text-red"><?php echo $errors->conditions->first('conditions'); ?></span>
                </div>
            </div>            
            <div class="form-group">
                &nbsp;
        ...
        <div class="col-md-6 wow fadeInRightBig animated">
            <div class="tlmd_form_page_image">
                <img src="<?php echo e(URL::to('public/assets/frontend/img/segundaopinion.png')); ?>"/>
            </div>
        </div>
        -->
        <!-- Modal -->
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h2 class="modal-title" id="exampleModalLabel">Debe aceptar las condiciones legales</h2>
                  <!--
                ...
                <div class="modal-footer">
                  <?php  echo Form::checkbox('conditions', null, null, array('id' => "conditions"));?> Acepto las condiciones legales
                  <button type="button" onclick="if($('#conditions').is(':checked')) { $('#myModal').modal('hide'); }" class="btn btn-primary">Aceptar</button>            
                </div>
              </div>
            </div>
        </div>
