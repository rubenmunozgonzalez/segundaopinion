...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
        ...
        <script src="<?php echo e(URL::asset('public/assets/frontend/js/moment.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('public/assets/frontend/js/jquery.cookiesdirective.js')); ?>"></script>  
