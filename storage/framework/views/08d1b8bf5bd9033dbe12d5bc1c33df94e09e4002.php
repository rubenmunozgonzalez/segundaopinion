        ...
        <?php echo CollectiveForm::open([
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    <!--<span class="help-block"><?php echo trans('Adjuntar los informes que tenga tanto de pruebas de imagen como de consultas'); ?></span>-->
            ...
            <div class="form-group">
                <div class="col-lg-10 col-lg-offset-2">
                    ...
                    <?php echo CollectiveForm::submit(trans('ticketit::lang.btn-submit'), ['class' => 'btn btn-default']); ?><i class="fa fa-cc-paypal fa-2x"></i>
                </div>
            </div>
