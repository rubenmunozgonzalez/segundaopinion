            ...
            <h2 class="header">
                ...
                <span class="pull-right">
                    <?php if($u->isAgent() || $u->isAdmin()): ?>
                        <?php if(! $ticket->completed_at && $close_perm == 'yes' && Auth::user()->id == $ticket->agent_id): ?>
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>
                                <strong><?php echo e(trans('ticketit::lang.unit')); ?></strong><?php echo e(trans('ticketit::lang.colon')); ?>

                                <span style="color: <?php echo e($ticket->unit->color); ?>">
