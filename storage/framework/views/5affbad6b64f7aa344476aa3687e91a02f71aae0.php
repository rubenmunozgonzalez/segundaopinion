                                ...
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="<?php echo e($setting->grab('email.color_button_bg')); ?>">
                                  ...
                                  <center>
                                    ...
                                    <a href="<?php echo URL::to('/adminChangePassword?username='.$username)?>"
                                       style="background-color:<?php echo e($setting->grab('email.color_content_bg')); ?>;color:#005AA4;display:inline-block;font-family: Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:300px;-webkit-text-size-adjust:none;">Cambiar contraseña</a>
                                <!--[if mso]>
                                  </center>
                                </v:roundrect>
                                <![endif]--></div>
