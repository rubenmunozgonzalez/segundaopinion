...
;(function($) {
	$.cookiesDirective = function(options) {
		...
		var settings = $.extend({
			...
			singleCookieScriptBeginningLabel: ' Nuestra web utiliza  ',
			singleCookieScriptEndLabel: ' cookies propias para ofrecerle un mejor servicio. ',			
			explicitCookieDeletionWarning: 'Si continúa navegando, consideramos que acepta su uso. .',
			explicitFindOutMore: 'Puede cambiar la configuración u obtener más información.',
			privacyPolicyLinkText: ' politica de privacidad',
			explicitCheckboxLabel: 'Debes seleccionar el checkbox "Acepto las cookies de este sitio web" para aceptar',
			explicitCookieAcceptanceLabel: 'Acepto las cookies de este sitio web',
	...
	var disclosure = function(options) {
		...
		if(!settings.message) {
			if(settings.explicitConsent) {
				...
				settings.message = 'Este sitio utiliza cookies. Algunas de estas cookies ';
				settings.message += 'son propias para ofrecerle un mejor servicio.';
			} else {
				// Implied consent message
				settings.message = 'Hemos descargado cookies en su ordenador para poder hacer esta página web mejor.';
			}		
		}	
